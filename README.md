...
![Solarized+Powerline](https://raw.github.com/StackAdapt/powerline-go/master/preview.png)
...
[releases tab](https://github.com/StackAdapt/powerline-go/releases)
...
```bash
go get -u github.com/StackAdapt/powerline-go
```
...
`$GOPATH/src/github.com/StackAdapt/powerline-go`, you'll instead see `@GOPATH-GH >
